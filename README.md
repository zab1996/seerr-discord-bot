...
Search movies and TV shows from Discord, preview IMDb / Rotten Tomatoes critic scores via OMDb, and send requests to your [Seerr](https://seerr.dev/) (or Overseerr-compatible) instance.
